<?php
            ...
            <!DOCTYPE html>
            <head><link rel="stylesheet" href="../css/style.css"><title>Onibaba</title>
            </head>
            <body>
            <nav>
            <a href='../start.php'>
            ...
            <div id='main-film'>
            <h1>Onibaba</h1>
            <div id='poster'><img src='../poster/Onibaba.jpg'></div>
            <div id='movie-info'><p>Regisseur: Shindō Kaneto</p><p>Genre: Drama-Horror</p><p>Datum: 1964-11-21</p><p>Dauern: 120</p></div>
            <p id='opinion'>Es wurde von <span style='color:blue;'>Tobias</span> geschrieben<span style='color:blue;font-weight:bold;'> : </span> "<i>Die Elemente des Nō-Theaters und des Horrorfilms"</i></p><div id='forum-link-bck'><a href='../forum.php?Topic=Onibaba' id='forum-link'>Forum</a></div>
            <div id='film-footer'>
