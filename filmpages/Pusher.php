<?php
            ...
            <!DOCTYPE html>
            <head><link rel="stylesheet" href="../css/style.css"><title>Pusher</title>
            </head>
            <body>
            <nav>
            <a href='../start.php'>
            ...
            <div id='main-film'>
            <h1>Pusher</h1>
            <div id='poster'><img src='../poster/Pusher.jpg'></div>
            <div id='movie-info'><p>Regisseur: Nicolas Winding Refn</p><p>Genre: Aktion</p><p>Datum: 1996-01-01</p><p>Dauern: 97</p></div>
            <p id='opinion'>Es wurde von <span style='color:blue;'>Yuka</span> geschrieben<span style='color:blue;font-weight:bold;'> : </span> "<i>Beginn vom Mads Mikkelsen"</i></p><div id='forum-link-bck'><a href='../forum.php?Topic=Pusher' id='forum-link'>Forum</a></div>
            <div id='film-footer'>
