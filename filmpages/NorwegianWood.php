<?php
            ...
            <!DOCTYPE html>
            <head><link rel="stylesheet" href="../css/style.css"><title>Norwegian Wood</title>
            </head>
            <body>
            <nav>
            <a href='../start.php'>
            ...
            <div id='poster'><img src='../poster/Norwegian Wood.jpg'></div>
            <div id='movie-info'><p>Regisseur: Tran Anh Hung</p><p>Genre: Drama</p><p>Datum: 2010-01-01</p><p>Dauern: 120</p></div>
            <p id='opinion'>Es wurde von <span style='color:blue;'>Yuka</span> geschrieben<span style='color:blue;font-weight:bold;'> : </span> "<i>Haruki Murakami und Jonny Greenwood bei uns vor Ort ;)"</i></p><div id='forum-link-bck'><a href='../forum.php?Topic=Norwegian Wood' id='forum-link'>Forum</a></div>
            <div id='film-footer'>
