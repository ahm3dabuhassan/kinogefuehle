<?php
            ...
            <div id='main-film'>
            <h1>Biutiful</h1>
            <div id='poster'><img src='../poster/Biutiful.jpg'></div>
            <div id='movie-info'><p>Regisseur: Alejandro González Iñárritu</p><p>Genre: Drama</p><p>Datum: 2011-03-10</p><p>Dauern: 140</p></div>
            <p id='opinion'>Es wurde von <span style='color:blue;'>Tobias</span> geschrieben<span style='color:blue;font-weight:bold;'> : </span> "<i>Der Abgesang des Uxbals.."</i></p><div id='forum-link-bck'><a href='../forum.php?Topic=Biutiful' id='forum-link'>Forum</a></div>
            <div id='film-footer'>
