<?php
            ...
            <div id='poster'><img src='../poster/There Will Be Blood.jpg'></div>
            <div id='movie-info'><p>Regisseur: Paul Thomas Anderson</p><p>Genre: Drama</p><p>Datum: 2007-02-14</p><p>Dauern: 130</p></div>
            <p id='opinion'>Es wurde von <span style='color:blue;'>deepViolet</span> geschrieben<span style='color:blue;font-weight:bold;'> : </span> "<i>Die beste Rolle vom Daniel-Day-Lewis"</i></p><div id='forum-link-bck'><a href='../forum.php?Topic=There Will Be Blood' id='forum-link'>Forum</a></div>
            <div id='film-footer'>
