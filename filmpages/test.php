<?php
            ...
            ?>
            <!DOCTYPE html>
            <head><link rel="stylesheet" href="../css/style.css"><title>test</title>
            </head>
            <body>
            <nav>
            <a href='../start.php'>
            ...
            <div id='main-film'>
            <h1>test</h1>
            <div id='poster'><img src='../poster/test.jpg'></div>
            <div id='movie-info'><p>Regisseur: test</p><p>Genre: test</p><p>Datum: 1991-11-01</p><p>Dauern: 120</p></div>
            <p id='opinion'>Es wurde von <span style='color:blue;'>deepViolet</span> geschrieben<span style='color:blue;font-weight:bold;'> : </span> "<i>hello"</i></p><div id='forum-link-bck'><a href='../forum.php?Topic=test' id='forum-link'>Forum</a></div>
            <div id='film-footer'>
