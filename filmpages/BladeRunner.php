<?php
            ...
            <div id='main-film'>
            <h1>Blade Runner</h1>
            <div id='poster'><img src='../poster/Blade Runner.jpg'></div>
            <div id='movie-info'><p>Regisseur: Ridley Scott</p><p>Genre: Sci-Fi</p><p>Datum: 1982-06-25</p><p>Dauern: 120</p></div>
            <p id='opinion'>Es wurde von <span style='color:blue;'>deepViolet</span> geschrieben<span style='color:blue;font-weight:bold;'> : </span> "<i>Soundtrack vom Vangelis!"</i></p><div id='forum-link-bck'><a href='../forum.php?Topic=Blade Runner' id='forum-link'>Forum</a></div>
            <div id='film-footer'>
