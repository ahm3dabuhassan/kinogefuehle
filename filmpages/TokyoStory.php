<?php
            ...
            ?>
            <!DOCTYPE html>
            <head><link rel="stylesheet" href="../css/style.css"><title>Tokyo Story</title>
            </head>
            <body>
            <nav>
            <a href='../start.php'>
            ...
            <div id='main-film'>
            <h1>Tokyo Story</h1>
            <div id='poster'><img src='../poster/Tokyo Story.jpg'></div>
            <div id='movie-info'><p>Regisseur: Yasujiro Ozu</p><p>Genre: Drama</p><p>Datum: 1953-11-03</p><p>Dauern: 140</p></div>
            <p id='opinion'>Es wurde von <span style='color:blue;'>deepViolet</span> geschrieben<span style='color:blue;font-weight:bold;'> : </span> "<i>Außergewöhnlich"</i></p><div id='forum-link-bck'><a href='../forum.php?Topic=Tokyo Story' id='forum-link'>Forum</a></div>
            <div id='film-footer'>
