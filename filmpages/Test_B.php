<?php
            ...
            ?>
            <!DOCTYPE html>
            <head><link rel="stylesheet" href="../css/style.css"><title>Test_B</title>
            </head>
            <body>
            <nav>
            <a href='../start.php'>
            ...
            <div id='main-film'>
            <h1>Test_B</h1>
            <div id='poster'><img src='../poster/Test_B.webp'></div>
            <div id='movie-info'><p>Regisseur: Test_B</p><p>Genre: Test_A</p><p>Datum: 1991-01-01</p><p>Dauern: 120</p></div>
            <p id='opinion'>Es wurde von <span style='color:blue;'>deepViolet</span> geschrieben<span style='color:blue;font-weight:bold;'> : </span> "<i>Test_A"</i></p><div id='forum-link-bck'><a href='../forum.php?Topic=Test_B' id='forum-link'>Forum</a></div>
            <div id='film-footer'>
