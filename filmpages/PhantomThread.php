<?php
            ...
            <div id='poster'><img src='../poster/Phantom Thread.jpg'></div>
            <div id='movie-info'><p>Regisseur: Paul Thomas Anderson</p><p>Genre: Drama</p><p>Datum: 2028-02-01</p><p>Dauern: 130</p></div>
            <p id='opinion'>Es wurde von <span style='color:blue;'>Yuka</span> geschrieben<span style='color:blue;font-weight:bold;'> : </span> "<i>Vicky Krieps und Soundtrack vom Jonny Greenwood!"</i></p><div id='forum-link-bck'><a href='../forum.php?Topic=Phantom Thread' id='forum-link'>Forum</a></div>
            <div id='film-footer'>
